...
const extraProducts = [
  { id: 9, brand: 'Maybelline', name: 'Super Stay Lumi-Matte Foundation', category: 'Rostro', price: 480, badge: 'Nuevo', description: 'Base ligera de larga duración con acabado luminoso-mate y cobertura modulable.', details: ['30 ml', 'Larga duración'], image: 'assets/Base-maquillaje-LOreal-2-1200x675.webp', imagePosition: '18% 45%', imageScale: 1.45 },
  { id: 10, brand: 'Maybelline', name: 'Fit Me Matte + Poreless', category: 'Rostro', price: 480, description: 'Base de acabado mate diseñada para ayudar a controlar brillo y suavizar visualmente los poros.', details: ['30 ml', 'Acabado mate'], image: 'assets/brands-curated-products.png', imagePosition: '56% 48%', imageScale: 2.05 },
  ...
  { id: 17, brand: 'Revlon', name: 'ColorStay Foundation', category: 'Rostro', price: 480, description: 'Base de larga duración con cobertura modulable para una apariencia uniforme durante el día.', details: ['30 ml', 'Larga duración'], image: 'assets/brands-curated-products.png', imagePosition: '73% 50%', imageScale: 2.0 },
  ...
  { id: 19, brand: 'Revlon', name: 'PhotoReady Candid Powder', category: 'Rostro', price: 480, description: 'Polvo para sellar el maquillaje y reducir brillo manteniendo una apariencia natural.', details: ['Polvo', 'Acabado natural'], image: 'assets/brands-curated-products.png', imagePosition: '8% 64%', imageScale: 2.25 },
...
const productImageManifest = Object.freeze({
  1: 'assets/products/serum True Match Super-Blendable Foundation.jpg',
